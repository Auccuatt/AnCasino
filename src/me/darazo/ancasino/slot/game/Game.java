 ...
 public class Game
 {
   ...
   public void play() {
     ...
     Long[] delay = { Long.valueOf(60L), Long.valueOf(80L), Long.valueOf(100L) };
     ...
     this.plugin.sendMessage(this.player, (String)getType().getMessages().get("start"));
 
     
     for (Integer i = Integer.valueOf(0); i.intValue() < 3; i = Integer.valueOf(i.intValue() + 1)) {
       task[i.intValue()] = Integer.valueOf(this.scheduler.scheduleSyncRepeatingTask((Plugin)this.plugin, new RotateTask(this, i), 0L, 6L));
       this.scheduler.scheduleSyncDelayedTask((Plugin)this.plugin, new StopRotateTask(this, task[i.intValue()]), delay[2 - i.intValue()].longValue());
     } 
 
     
     this.scheduler.scheduleSyncDelayedTask((Plugin)this.plugin, new ResultsTask(this), delay[2].longValue());
   }
 }
