   ...
   public Boolean process() {
     ...
     if (this.args.length >= 2 && this.args.length <= 3) {
       ...
       if (!this.plugin.slotData.isSlot(this.args[1]).booleanValue())
       {
         ...
         SlotMachine slot = new SlotMachine(this.name, this.type, this.owner, this.world, Boolean.valueOf(false));
       ...
       {
         sendMessage("Slot machine " + this.args[1] + " already registered.");
       }
