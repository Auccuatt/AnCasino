 ...
 public class AnCasino extends JavaPlugin {
   ...
   public void onDisable() {
     this.logger.info(String.valueOf(this.prefix) + " Saving and unloading data..");
   ...
   public void onEnable() {
     ...
     if (!pm.isPluginEnabled("Vault")) {
       ...
       this.logger.warning(String.valueOf(this.prefix) + " Vault is required in order to use this plugin.");
       this.logger.warning(String.valueOf(this.prefix) + " dev.bukkit.org/server-mods/vault/");
       pm.disablePlugin((Plugin)this);
 
     
     }
     else if (!setupEconomy().booleanValue()) {
       this.logger.warning(String.valueOf(this.prefix) + " An economy plugin is required in order to use this plugin.");
       pm.disablePlugin((Plugin)this);
     } 
   }
   ...
   public void sendMessage(Player player, String message) {
     message = String.valueOf(this.configData.prefixColor) + this.prefix + this.configData.chatColor + " " + message;
   ...
   private Boolean setupEconomy() {
     ...
     return (this.economy != null) ? Boolean.valueOf(true) : Boolean.valueOf(false);
   }
 }
